<script>
    ...
    let gamesPromise = $state(fetchGames());
    ...
    // Add star
    async function addStar(gameId, games) {
        try {
...
<svelte:head>
    ...
    <link
        rel="icon"
        href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 10 10'><circle cx='5' cy='5' r='4' fill='%23007bff'/></svg>"
    />
</svelte:head>
